...
class _AccessIscrittiState extends State<AccessIscritti> {
  ...
  Widget build(BuildContext context) {
    initializeApp() async {
      ...
      secondaryApp = FirebaseProjectsManager().getDefault();
      print("defaultApp : $secondaryApp");
      isIOS = Theme.of(context).platform == TargetPlatform.iOS;
      database = FirebaseDatabase(app: secondaryApp);
      _auth = FirebaseAuth.instanceFor(app: secondaryApp);
      final firebaseUser =
          FirebaseAuth.instanceFor(app: secondaryApp).currentUser;
                            ...
                            if (firebaseAuthCheck != null) {
                              await database
                                ...
                                LinkedHashMap<dynamic, dynamic> values =
                                    snapshot.value;
                                String username;
                                Map<String, String> map = values.map((a, b) =>
                                    MapEntry(a as String, b as String));
