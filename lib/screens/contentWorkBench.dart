                      ...
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                          setState(() {
                            ...
                            widgetsInfos.addAll({chiavetta: widgetInfo});
                            index++;
                        ...
                        if (_formKey.currentState.validate()) {
                          ...
                          setState(() {
                            ...
                            if (widgetInfo["VideoPath"] != null) {
                              ...
                              widgetInfo.addAll({"isVideo": true});
                            }
                            widgetsInfos.addAll({chiavetta: widgetInfo});
                            index++;
                            _linkController.clear();
